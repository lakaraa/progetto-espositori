...
<section class="section section-lg bg-default">
    <div class="container">
        <div class="text-center">
            <h2 class="heading-decoration"><span class="text-primary">Gestione</span> Personale</h2>
            <p class="subtitle">Aggiungi, modifica o elimina i membri del personale</p>
        </div>
        ...
        <div class="row row-30 row-md-50 justify-content-center mt-5">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="dashboard-card">
                    <a class="dashboard-card-link" href="aggiungi_personale.php">
                        <div class="dashboard-card-icon">
                            <span class="icon-lg mdi mdi-account-plus"></span>
                        </div>
                        <h5 class="dashboard-card-title">Aggiungi</h5>
                        <p class="dashboard-card-text">Nuovo membro del personale</p>
                    </a>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="dashboard-card">
                    <a class="dashboard-card-link" href="modifica_personale.php">
                        <div class="dashboard-card-icon">
                            <span class="icon-lg mdi mdi-account-edit"></span>
                        </div>
                        <h5 class="dashboard-card-title">Modifica</h5>
                        <p class="dashboard-card-text">Dati del personale</p>
                    </a>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="dashboard-card">
                    <a class="dashboard-card-link" href="cancella_personale.php">
                        <div class="dashboard-card-icon">
                            <span class="icon-lg mdi mdi-account-remove"></span>
                        </div>
                        <h5 class="dashboard-card-title">Elimina</h5>
                        <p class="dashboard-card-text">Membro del personale</p>
                    </a>
                </div>
            </div>
        </div>
