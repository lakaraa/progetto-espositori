...
function addPrenotazioneByPersonale($pdo, $visitatore, $manifestazione, $turno) {
    ...
    // Verifica che il turno esista E sia collegato alla manifestazione selezionata
    $sqlTurno = "SELECT Id_Turno FROM turno WHERE Id_Turno = :turno AND Id_Manifestazione = :manifestazione";
